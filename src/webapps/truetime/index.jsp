...
<html lang="eng">
  <head>
    {{> head_meta }}
    {{> resources }}
    <title>Red5 TrueTime Solutions&#8482;</title>
    <style>
      .content-section_card_em {
        font-style: italic;
      ...
      <div id="content-section">
        <div id="subcontent-section">
          <div id="subcontent-section-text">
            <h1>Red5 TrueTime Solutions&#8482;</h1>
            <p class="heading-title">Mix and match the open source Red5 TrueTime Solutions™ to create next-generation streaming apps like you’ve never seen before. Engage your customers with new products and possibilities.</p>
            <p><a class="link" style="color: white;" target="_blank" href="https://red5.net/truetime">Find out more about Red5 TrueTime Solutions&#8482;</a></p>
          </div>
        </div>
        {{> header }}
        <div class="content-section-story">
          <div class="content-section_card">
            <h3 class="content-section_card_title"><a class="card-link" href="/truetime-datasync/index.html?intro=true">TrueTime DataSync&#8482;</a></h2>
            ...
            <div class="content-section_card_info">
              ...
              <div class="content-section_card_tray">
                <p class="content-section_card_link"><a class="card-link" href="/truetime-datasync/index.html?intro=true">Try out TrueTime DataSync</a></p>
              </div>
            </div>
          </div>
          <div class="content-section_card">
            <h3 class="content-section_card_title"><a class="card-link" href="/truetime-multiview/index.html?intro=true&vod=false&embed=true&debug=true">TrueTime MultiView&#8482;</a></h2>
            ...
            <div class="content-section_card_info">
              ...
              <div class="content-section_card_tray">
                <p class="content-section_card_link"><a class="card-link" href="/truetime-multiview/index.html?intro=true&vod=false&embed=true&debug=true">Try out TrueTime MultiView</a></p>
              </div>
            </div>
          </div>
          <div class="content-section_card">
            <h3 class="content-section_card_title"><a class="card-link" href="/truetime-webinar/">TrueTime Studio&#8482; for Webinars</a></h2>
            ...
            <div class="content-section_card_info">
              ...
              <div class="content-section_card_tray">
                <p class="content-section_card_link"><a class="card-link" href="/truetime-webinar/">Try out TrueTime Studio</a></p>
              </div>
            </div>
          </div>
          <div class="content-section_card">
            <h3 class="content-section_card_title"><a class="card-link" href="/truetime-watchparty/">TrueTime WatchParty&#8482; for Fans</a></h2>
            <p><a class="link" target="_blank" href="https://github.com/red5pro/truetime-watchparty">Get the Code!</a></p>
            ...
            <div class="content-section_card_info">
              ...
              <div class="content-section_card_tray">
                <p class="content-section_card_link"><a class="card-link" href="/truetime-watchparty/">Try out TrueTime WatchParty</a></p>
              </div>
            </div>
          </div>
        </div>
