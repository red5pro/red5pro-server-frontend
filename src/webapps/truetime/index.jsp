      ...
      <div id="content-section">
        <div id="subcontent-section">
          <div id="subcontent-section-text">
            ...
            <p>Mix and match the open source Red5 TrueTime Solutions™ to create next-generation streaming apps like you’ve never seen before. Engage your customers with new products and possibilities.</p>
            <p><a class="link" target="_blank" href="https://red5.net/truetime">Find out more about Red5 TrueTime Solutions&#8482;!</a></p>
          </div>
        </div>
        ...
        <div class="content-section-story">
          ...
          <div class="content-section_card">
            <h2 class="content-section_card_title"><a class="card-link" href="/truetime-webinar/">TrueTime Studio&#8482; for Webinars</a></h2>
            ...
            <div class="content-section_card_tray">
              <p class="content-section_card_link"><a class="card-link" href="/truetime-webinar/">Try out TrueTime Studio&#8482; - Webinar&nbsp;&nbsp;<img decoding="async" loading="lazy" src="images/white-arrow.svg" data-src="" alt="" width="16" height="16"></a></p>
            </div>
          </div>
          <div class="content-section_card">
            <h2 class="content-section_card_title"><a class="card-link" href="/truetime-watchparty/">TrueTime WatchParty&#8482; for Fans</a></h2>
            <p><a class="link" target="_blank" href="https://github.com/red5pro/truetime-watchparty">Get the Code!</a></p>
            ...
            <div class="content-section_card_tray">
              <p class="content-section_card_link"><a class="card-link" href="/truetime-watchparty/">Try out TrueTime WatchParty&#8482; - Fans&nbsp;&nbsp;<img decoding="async" loading="lazy" src="images/white-arrow.svg" data-src="" alt="" width="16" height="16"></a></p>
            </div>
          </div>
          {{> web-applications }}
          {{> mobile-applications }}
